...
alpha_w = st.sidebar.slider('alpha_w : ', value=0.005, min_value=0.000, max_value=1.0, step=0.001)
alpha_cond= st.sidebar.slider('alpha_cond : ', value=0.0025, min_value=0.0000, max_value=1.0, step=0.0001)
CW_flowrate =  st.sidebar.slider('Coling water flow rate : ', value=125.0, min_value=0.0, max_value=2000.0, step=1.0)
n =  st.sidebar.slider('Number of segments of the experiments : ', value=8.0, min_value=8.0, max_value=1000.0, step=1.0)
